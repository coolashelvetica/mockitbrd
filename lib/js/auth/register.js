...
/* Algorithim for image radio buttons */
	...
	$(".goToStep1, #twentyfive").click(function () {
		...
		$(".prevStep").removeClass("hide, goToStep1, goToStep2, goToStep3, goToStep4");
	...
	$(".goToStep2, #fifty").click(function () {
		...
		$(".nextStep").removeClass("goToStep1");
		$(".nextStep").removeClass("goToStep2");
		$(".nextStep").removeClass("goToStep4");
