...
/* Algorithim for image radio buttons */
	...
	$(".goToStep3, #seventyfive").click(function () {
		...
		$("#nextStep").removeClass("hide goToStep1 goToStep4 goToStep2").addClass("goToStep4");
		$("#prevStep").removeClass("hide  goToStep2 goToStep1 goToStep4").addClass("goToStep2");
	});
	$(".goToStep4, #onehundred").click(function () {
		...
		$("#nextStep").removeClass("hide goToStep1 goToStep3 goToStep2 goToStep4").addClass("hide");
		$("#prevStep").removeClass("hide  goToStep2 goToStep3 goToStep4").addClass("goToStep3");
	});
});