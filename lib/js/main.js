 ...
 * http://mockitbrd.com
 */
 /*global Mockit, requirejs, console*/
requirejs.config({
...
require(["helper/domReady!",  "helper/base", "auth/login", "auth/register", "modernizr", "control/AppController", "helper/errors", "helper/try-catch", "jquery"], function (doc, base, login, register, Modernizr, AppController, errors, tryCatch, $) { //create Mockit.brd dom helper
